            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-12 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
                    ...
                    <p className="text-slate-300 text-sm leading-relaxed">
                        Select from Max Rx® (combine mindwell benefits), Thrive, or Clear genetic tests and full spectrum blood test. We recommend purchasing all three with a 12-week coaching package for optimal results. Include that genetic testing is a one-time test because your genetics do not change.
                    </p>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[400px] lg:h-[500px] rounded-3xl overflow-hidden bg-gradient-to-br from-slate-800/40 to-slate-900/60 border border-slate-700/30 backdrop-blur-sm">
                            ...
                            <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-slate-300 text-sm leading-relaxed">
                                        Get your blood drawn at either Quest or LabCorp. Our medical team analyzes your DNA and full spectrum blood panel for comprehensive insights including hormonal imbalances.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="relative h-[400px] lg:h-[500px] rounded-3xl overflow-hidden bg-gradient-to-br from-slate-800/40 to-slate-900/60 border border-slate-700/30 backdrop-blur-sm">
                            ...
                            <div className="relative z-10 p-8 h-full flex flex-col justify-between">
                                ...
                                <div className="space-y-4">
                                    ...
                                    <p className="text-slate-300 text-sm leading-relaxed">
                                        Receive detailed, actionable reports and begin your customized 12-week diet, workout and sleep plan with vitamin therapy. Your hormones will mimic a 21-year-old and turn back your calendar age by up to 10 years.
                                    </p>
                                </div>
                            </div>
