    ...
    <section className="py-24 bg-background">
      <div className="mx-auto max-w-7xl px-6 lg:px-12">
        ...
        <div className="flex justify-center">
          <Card className="max-w-3xl relative overflow-hidden shadow-2xl shadow-brand-accent/10 hover:shadow-2xl hover:shadow-brand-accent/20 transition-all duration-500">
            ...
            <div className="relative z-10">
              <Header>
                <Plan>
                  <PlanName className="flex items-center gap-3 text-2xl">
                ...
                <Description className="text-muted-foreground text-lg leading-relaxed">
                ...
                <Price>
                  <div className="flex items-baseline gap-2">
                    <MainPrice className="text-6xl font-black bg-gradient-to-r from-brand-accent via-brand-primary to-brand-accent bg-clip-text text-transparent">
                      $199
                    </MainPrice>
                    <Period className="text-muted-foreground text-lg">/month</Period>
                  </div>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-sm text-brand-accent bg-brand-accent/10 px-3 py-1 rounded-full border border-brand-accent/20">Limited Time</span>
                    <span className="text-sm text-muted-foreground line-through">$299/month</span>
                  </div>
                </Price>
              </Header>
              ...
              <Body>
                <div className="space-y-8">
                  <div>
                    <h4 className="font-bold text-xl text-brand-accent mb-6 flex items-center gap-3">
                    ...
                    <List>
                      <ListItem className="group">
                        ...
                        <span className="text-foreground group-hover:text-brand-accent transition-colors duration-200">
                ...
                <div className="pt-4">
                  <Button 
                    asChild
                    size="lg" 
                    className="w-full rounded-full bg-gradient-to-r from-brand-accent to-brand-primary hover:from-brand-accent/90 hover:to-brand-primary/90 text-white font-semibold px-8 py-4 h-14 text-base shadow-2xl shadow-brand-accent/20 hover:shadow-brand-accent/30 transition-all duration-300 hover:scale-105"
                  >
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              asChild
              size="lg" 
              className="rounded-full bg-gradient-to-r from-brand-accent to-brand-primary hover:from-brand-accent/90 hover:to-brand-primary/90 text-white font-semibold px-8 py-4 h-14 text-base shadow-2xl shadow-brand-accent/20 hover:shadow-brand-accent/30 transition-all duration-300 hover:scale-105"
            >
              <Link href="/select-profile" className="cursor-pointer">Book Free Consultation</Link>
            </Button>
            <Button 
              ...
              size="lg" 
              variant="outline" 
              className="rounded-full border-brand-accent/30 hover:bg-brand-accent/10 hover:border-brand-accent/50 text-brand-accent hover:text-brand-accent cursor-pointer transition-all duration-300 px-8 py-4 h-14 text-base"
            >
